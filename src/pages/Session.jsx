...
//             ...doc.data(),
//           }));
//           console.log("✅ Sessions hentet:", fetchedSessions);
...
//   // 🔹 Når man trykker "New Session"
//     // const newSession = async () => {
      
  
//     //   const selectedCampaign = campaign[openedIndex];
//     //   if (!selectedCampaign) return;
  
//     //   try {
//     //     // Opret en ny tom session baseret i den pågældende campaign
...
//     //     console.log("✅ Ny tom session oprettet i Firestore!");
  
//     //     navigate("/session-edit"); // Navigér til "Session-Edit"
//     //   } catch (error) {
//     //     console.error("🔥 Fejl ved oprettelse af ny tom session:", error);
//     //   }
//     // };

//   return (
//     {sessions.map(({ sessNr, title, campaignId, combatMaps, encounters, dmNotes }) => (
      
//     <div 
//     key={sessions.id}
//     className="flex justify-center space-x-8 p-8 min-h-screen bg-[#1C1B18]">
//       <h1 {campaignId}></h1>
...
//               <button
//                 className="addSess"
//                 onClick={[() => navigate("/session-edit"), newSession]}
//               >
//                 Change
//               </button>
//               <button
