export default function CampaignComp({ nr, date, title, template, onHover, onLeave }) {
  return (
    <div
    ...
    >
      ...
      <p className="text-sm text-gray-400 mb-2">Campaign #{nr}</p>
      <p className="text-gray-300 italic">{template}</p>
