const Border = () => {
  return (
    <div className="fixed inset-5 md:inset-6 lg:inset-8 pointer-events-none z-50">
      <div className="fixed inset-5 md:inset-6 lg:inset-8 pointer-events-none z-50">
        {/* Top Left Corner */}
        <div className="absolute top-0 left-0 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20">
          <img
        ...
        {/* Top Right Corner */}
        <div className="absolute top-0 right-0 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 rotate-90">
          <img
            src="/images/corners.svg"
            alt=""
            className="w-full h-full object-contain"
        ...
        {/* Bottom Left Corner */}
        <div className="absolute bottom-0 left-0 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 rotate-270">
          <img
            src="/images/corners.svg"
            alt=""
            className="w-full h-full object-contain"
        ...
        {/* Bottom Right Corner */}
        <div className="absolute bottom-0 right-0 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 rotate-180">
          <img
            src="/images/corners.svg"
            alt=""
            className="w-full h-full object-contain"
